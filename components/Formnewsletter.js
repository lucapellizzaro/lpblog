  ...
  return (
    <div>
      <form>
        ...
        <button
          type="submit"
          className="transition-colors duration-300 ease-in-out uppercase relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-brand-600 hover:bg-brand-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500"
        >
          Mi iscrivo!
        </button>
      </form>
